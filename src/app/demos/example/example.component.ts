import { ApplicationRef, Component, ComponentFactoryResolver, ComponentRef, EmbeddedViewRef, InjectFlags, Injector, OnInit, ProviderToken, ViewEncapsulation } from '@angular/core';
...
export class ExampleComponent implements OnInit {
  private container:AlertComponent | null;
  ...
  private getContainer():AlertComponent{
    ...
    //将组件到模板(包括app-alert标签)，添加到body最后
